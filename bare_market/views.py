...
class Question1(Page):
    ...
    form_fields = ['training_my_profit_1']
    question = _(u"Consider the following hypothetical scenario. Your chosen quality is 0,\
                 ...
                 In this context, your profit would be ...\
                 ...
                 In questo contesto, il tuo profitto sarebbe ...")
...
class Question2(Page):
    template_name = 'global/Question.html'
    form_model = models.Player
    form_fields = ['training_my_profit_2']
